                    ...
                    <div className="bg-[#1c1c1e] rounded-3xl p-4 border border-white/5 mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex gap-2 shrink-0">
                                <button className="w-10 h-10 rounded-full bg-[#D2FF1D]/10 border border-[#D2FF1D]/20 flex items-center justify-center cursor-pointer hover:bg-[#D2FF1D]/20 transition-colors">
